...
*/
    	System.out.println("+++ HANDLE INPUT DATA : KTSyncData.state = "+ KTSyncData.state + " ch = " + ch + " writePtr = "+ KTSyncData.writePtr);
            ...
            {   
            	if ( KTSyncData.bIsConnected ) {
	               	if ( wPtr != rPtr ) {               
	                    ...
	                    System.out.println("+++ run() +++ --> state = " + KTSyncData.state);
